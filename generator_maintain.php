...
?>			
			...
			<tr height="30">
			 ...
			 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			 <td>				
				<input type="text" name="nextduedate" id="nextduedate" value="<?php echo date('d-m-Y'); ?>" size="30" autocomplete='off' tabindex="5" class="datepicker" />
			</td>
			</tr>
			<tr height="30">
			 ...
			 <td><input type='text' name='add_currency' id='add_currency' value="<?php echo $currency_name;?>" size="7"  readonly="true" tabindex="7" autocomplete="off"/>
			 </td>
			</tr>
		   </table>
		   </td>
	 ...
	 <table >
			 <tr>
			  ...
			  <table>
				...
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>				
				<td>
				<input type="text" name="mduedate" id="mduedate" value="<?php echo date('d-m-Y'); ?>" size="30" autocomplete='off' tabindex="2" class="datepicker"/>	
				</td>
				</tr>				
				<tr height="30">
				 ...
				 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				 <td>
					<input type='text' name='donedate' id='donedate' value="<?php echo date('d-m-Y'); ?>" size="30" tabindex="4" autocomplete="off" class="datepicker"/>
				  </td>
				</tr>
				<tr height="30">
				 ...
				 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				 <td>					
					<input type='text' name='desc' id='desc' size="30" tabindex="6" autocomplete="off"/>					
				  </td>
				</tr>
				<tr height="30">
			 ...
			 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			 <td>				
				<input type="text" name="addcost" id="addcost" style="text-align:right;" size="30" autocomplete='off' tabindex="8" />				
			  </td>
			</tr>
		   </table>
		   </td>
