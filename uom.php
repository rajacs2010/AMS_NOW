...
<script>
$(function(){
$("#content").load("ajax_uom.php");

//PAGE NUMBER onClick FUNCTION
$(".page").live("click", function(){
var page = $(this).attr("id");
$("#content").load("ajax_uom.php?page="+page);
});
});
</script>
<script>
...
$("#content").load("ajax_uom.php?searchvalue="+searchvalue);
  });
});
</script>
</script>
...
echo '<div class="success_message">Uom created successfully</div>';
}
else
{
...
echo '<div class="success_message">Uom  updated successfully</div>';
}
else
{
echo '<div class="error_message">The name should not be empty</div>';
...
&nbsp;
<form id='uom_save' action="<?php echo $_SERVER['PHP_SELF'];?>" onsubmit="return validateForm()"  method='post' accept-charset='UTF-8'>
                    ...
                    <tr>
                       <td  width="150px"><label style="margin-left:0px;">uom<em style="font-style:normal;color:red;">*</em></label></td>
						...
						<?php if(isset($_GET['id'])){ ?>
							<input type='text' name='uom' id='uom' class="textbox" value="<?php echo $name; ?>"/>
