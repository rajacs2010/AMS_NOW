...
function validateForm()
{
	...
	{
		$('.myalignbuild').html('ERR 0009 : Select Owned/Landlord/Rented');
	$('#errormsgbuild').css('display','block');
			setTimeout(function() {
				$('#errormsgbuild').hide();
			},5000);
		...
		if(genrator_status.value==1)
	{
		...
		if(cost.value=="")
		{
		$('.myalignbuild').html('ERR 0009 : Enter The Cost');
		$('#errormsgbuild').css('display','block');
			setTimeout(function() {
				$('#errormsgbuild').hide();
			},5000);
		...
		{
		$('.myalignbuild').html('ERR 0009 : Enter The Maintenance Contract Number');
		$('#errormsgbuild').css('display','block');
			setTimeout(function() {
				$('#errormsgbuild').hide();
			},5000);
		...
		return false;
			...
			if(mcost.value=="")
			{
			$('.myalignbuild').html('ERR 0009 : Enter The Maintenance Cost');
			$('#errormsgbuild').css('display','block');
					setTimeout(function() {
						$('#errormsgbuild').hide();
					},5000);
		...
		{
		$('.myalignbuild').html('ERR 0009 : Select The Period');
			$('#errormsgbuild').css('display','block');
					setTimeout(function() {
						$('#errormsgbuild').hide();
					},5000);
		...
		{
		$('.myalignbuild').html('ERR 0009 : Select The Contract Renewal Date');
			$('#errormsgbuild').css('display','block');
					setTimeout(function() {
						$('#errormsgbuild').hide();
					},5000);
	...
	if(genrator_status.value==2)
	{
		...
		if(rent.value=="")
		{
		$('.myalignbuild').html('ERR 0009 : Enter The Rent');
			$('#errormsgbuild').css('display','block');
					setTimeout(function() {
						$('#errormsgbuild').hide();
					},5000);
		...
		return false;
			...
			{
			$('.myalignbuild').html('ERR 0009 : Enter The Period');
			$('#errormsgbuild').css('display','block');
					setTimeout(function() {
						$('#errormsgbuild').hide();
					},5000);
			...
			{
			$('.myalignbuild').html('ERR 0009 : Enter The Contract Renewal Date');
			$('#errormsgbuild').css('display','block');
					setTimeout(function() {
						$('#errormsgbuild').hide();
					},5000);
...
<script>
 $(document).ready(function() { 
	...
	var cost=document.getElementById("cost").value;
		...
		{
		$('.myalignbuild').html('ERR 0009 : Enter Only Numbers ');
		$('#errormsgbuild').css('display','block');
			setTimeout(function() {
				$('#errormsgbuild').hide();
			},5000);
...
$fgmembersite->RedirectToURL("generator.php?success=create");
}
?>
<?php
if(isset($_POST['edit']))
...
if ($state != "")
{
if(!mysql_query('UPDATE stat22e SET name="'.$state.'",updated_at="'.$current_date.'",updated_by="'.$user_id.'" WHERE id="'.$edit_id.'" '))
{
die('Error: ' . mysql_error());
}
		...
		<table align="left">
		 <tr>
		  ...
		  <table>
			...
			<input type="text" name="code" id="code" size="15" value="<?php echo $generator_code;?>" readonly maxlength="10" autocomplete='off' readonly="true" tabindex="1"/>
			...
			<tr height="40">
			 ...
			 <td>
				...
				<input type="text" name="model" id="model" size="15" autocomplete='off' tabindex="5"  value="<?php echo $model;?>"/>
			 ...
			 <tr>
			  ...
			  <table>
				...
				<td>
					...
					<textarea name='desc' id='desc' size="30" tabindex="2"><?php echo $desc;?></textarea>
				...
				<tr height="40">
				 ...
				 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				 <td>
					<input type='text' name='make' id='make' size="15" tabindex="4" value="<?php echo $make;?>" autocomplete="off" />
				  </td>
				</tr>
				<tr height="40">
				 ...
				 <td>
					...
					<input type='text' name='rating' id='rating' size="15" tabindex="6" value="<?php echo $rating;?>" autocomplete="off"/>
...
<fieldset class="alignment" align="left">
  <legend><strong>Owned/Landlord/Rented</strong></legend>
  <table width="100%">
  <tr>
  <td width="20%">Owned/Landlord/Rented*</td>
  <td>
			...
			<tr height="40">
			 ...
			 <td>
				<?php
							...
							?>
							<input type='text' name='total_currency' id='total_currency' value="<?php echo $currency_name;?>" size="15"  readonly="true" tabindex="10"/>	
			...
			<tr height="40">
			 ...
			 <td>
				<?php
							...
							?>
							<input type='text' name='maintain_currency' id='maintain_currency' value="<?php echo $currency_name;?>" size="15"  readonly ="true" tabindex="14" autocomplete="off"/>	
	 ...
	 <table >
			 <tr>
			  ...
			  <table>
				...
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td>
					<input type="text" name="cost" id="cost" size="15" autocomplete='off' tabindex="9" style="text-align:right;" value="<?php echo $cost;?>"/>
				</td>
				</tr>
				
				<tr height="40">
				 <td width="120">Maintenance Contract Number*</td>
				 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				 <td>
				...
				<tr height="40">
				 ...
				 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				 <td>
					<input type='text' name='mcost' id='mcost' size="15" tabindex="13" style="text-align:right;" value="<?php echo $mcost;?>" autocomplete="off"/>
		 ...
		 <tr>
		  ...
		  <table>
			...
			<tr height="40">
				 ...
				 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				 <td>
					<input type='text' name='mcost_landlord' id='mcost_landlord' size="15" tabindex="12"  style="text-align:right;" autocomplete="off"/>
	 ...
	 <table >
			 ...
			 <td>
				<?php
							...
							?>
							<input type='text' name='maintain_currency' id='maintain_currency' value="<?php echo $currency_name;?>" size="15" tabindex="13" readonly="true" autocomplete="off"/>	
			 ...
			 <td>
				...
				<input type="text" name="renewaldate_landlord" id="renewaldate_landlord"  class="datepicker" size="15" autocomplete='off' tabindex="15"/>
