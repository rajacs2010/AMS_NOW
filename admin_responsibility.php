...
if(isset($_POST['formsaveval']) && $_POST[formsaveval] == 800) {
	...
	//exit;
	$fgmembersite->DBLogin();
	if(!mysql_query('INSERT INTO admin_responsibility SET responsibility_id="'.$responsibility_id.'",lead_code="'.$incharge_empcode.'",lead_name="'.$leader_name.'",company_id="'.$comp_id.'",division_id="'.$division_id.'",city_id="'.$city_id.'", office_location="'.$off_loc.'",office_building_id="'.$off_buil_id.'",office_floor="'.$off_floor.'",office="'.$office_val.'",email_id="'.$email_id.'",mobile_number="'.$mobile_no.'",alt_number="'.$alt_num.'",alt_lead_code="'.$incharge_empcode_alt.'",alt_lead_name="'.$alt_leader_name.'",picture="'.$req_picture.'",created_by="'.$user_id.'" ')) {
...
<div class="mcf"></div>
<div align="center" class="headingsgr">ADMIN RESPONSIBILITY</div>
...
<table width="50%" align="left">
 <tr>
  ...
  <table>
    <tr height="30">
     <td width="120" nowrap="nowrap">Responsibility Center</td>
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td>
	 <?php 
		$fgmembersite->DBLogin();
 ...
 <tr>
  ...
  <table>
	...
	<tr height="30">
	 ...
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><input type='text' name='off_loc' id='off_loc' tabindex="6" value="" class="textbox"/></td>
	</tr>
	...
	<tr height="30">
		...
		<td><?php
			...
			echo '<select name="off_buil_id" id="off_buil_id" tabindex="8" >';
			echo '<option value="0">--Select--</option>';
			while($row=mysql_fetch_array($result_state)) {
	...
	<tr height="30">
	 ...
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><input type='text' name='off_floor' id='off_floor' tabindex="9" value="" class="textbox"/></td>
	</tr>
 ...
 <tr>
  <td>
   ...
   <tr height="30">
	 ...
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td>
     <div id="display_state"><input type='text' name='state_name' id='state_name' readonly="true"/ ></div>
     </td>
	</tr>
	...
	<tr height="30">
		 ...
		 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		 <td><input type='text' name='off_buil' id='off_buil' tabindex="7" value="" class="textbox"/></td>
	</tr>
	...
	<tr height="30">
		...
		<td><div id="display_off_buil_code">
			<input type='text' name='off_buil_code' id='off_buil_code' size="6" readonly autocomplete="off" class="textbox" />
			</div>
		</td>
    </tr>
	...
	<tr height="30">
		 ...
		 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		 <td><input type='text' name='office_val' id='office_val' class="textbox" tabindex="10" autocomplete="off" /></td>
	</tr>
 ...
 <tr>
  ...
  <table>
    <tr height="30">
	 ...
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><input type='text' name='email_id' id='email_id' tabindex="11" autocomplete="off" class="textbox" /></td>
	</tr>
    
    <tr height="30">
    <td width="120" nowrap="nowrap">Alternate No.</td>
	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td><input type='text' name='alt_num' id='alt_num' tabindex="13" autocomplete="off" /></td>
    </tr>
   </table>
   </td>
 </tr>
 ...
 <tr>
  <td>
   ...
   <tr height="30">
		 ...
		 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		 <td><input type="text" name="mobile_no" id="mobile_no" tabindex="12" autocomplete="off"  /></td>
	</tr>
	
   <tr height="30">
     <td width="120">Picture</td>
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><input type='file' name='req_picture' id='req_picture' tabindex="14" value="" autocomplete="off"  /></td>
	</tr>
...
<table width="100%" align="left">
 <tr>
  <td>
<fieldset align="left" class="alignment2">
  <legend ><strong>Alternate Leader</strong></legend>
<table width="50%" align="left">
 <tr>
  <td>
   <table> 
	<tr height="30">
		...
		<?php
			...
			mysql_select_db($mysql_database, $bd) or die("Opps some thing went wrong");
			$result_emp_id=mysql_query("select emp_code,first_name from pim_emp_info  order by emp_id",$bd);
			echo '<select name="incharge_empcode_alt" id="incharge_empcode_alt" size="1" position="absolute" onclick="size=(size!=1)?2:1;" style="width:100px;" tabindex="15" class="selectbox">';
			echo '<option value="0">--Employee--</option>';
			while($row=mysql_fetch_array($result_emp_id))
			{
				echo '<option value="'.$row['emp_code'].'">'.$row['first_name'].'</option>';
 ...
 <tr>
  ...
  <table>
    <tr height="30">
	 ...
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td>
	<span id="display_inchargename_alt"><input type='text' name='alt_leader' id='alt_leader' size="5" readonly class="textbox"/></span>
	 </td>
	</tr>
