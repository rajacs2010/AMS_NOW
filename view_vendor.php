...
<script>
$(function(){
$("#page_show").load("ajax_viewvendor.php");

//PAGE NUMBER onClick FUNCTION
$(".page").live("click", function(){
var page = $(this).attr("id");
$("#page_show").load("ajax_viewvendor.php?page="+page);
});
});
</script>
...
$("#page_show").load("ajax_viewvendor.php?searchvalue="+searchvalue);
  });
});
</script>
<?php
...
die('Error: ' . mysql_error());
 ...
 echo '<div class="success_message">vendor deleted successfully</div>';
...
&nbsp;
<div class="header_bold">View Vendor</div>
<br/>
<br/>
<br/>
