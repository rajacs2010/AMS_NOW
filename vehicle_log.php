 ...
 <tr>
  ...
  <table>
	...
	<tr height="30">
	 ...
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><?php
			$result_state=mysql_query("SELECT id,name FROM driver");
	...
	?>
   <input type='text' name='trip_no' id='trip_no' style="width:60px;" class="textbox" value="<?php echo $customer_code;?>" readonly="true"/>
       </td>
	</tr>

	<tr height="30">
     <td width="120">Starting Date & Time*</td>
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td>
	...
	<tr height="30">
	 ...
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td>
		<input type="text" name="starting_reading" id="starting_reading" class="textbox" tabindex="11" autocomplete="off" style="text-align:right;" />
	 </td>
	</tr>
	...
	<tr height="30">
	 ...
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><input type='text' name='total_distance' id='total_distance' class="textbox" tabindex="11" autocomplete="off" style="text-align:right;" /></td>
	</tr>
	
	<tr height="30">
     <td width="120">Travel Description</td>
	 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><input type='text' name='desc_log' id='desc_log' class="textbox" tabindex="11" autocomplete="off" style="text-align:right;" />
	 </td>
	</tr>
   </table>
   </td>
